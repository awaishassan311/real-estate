...
const dropdoun_data: InputField[] = [
   ...
   },
   {
      ...
      col: "col-xl-4",
      label: "Location",
      options: [{ value: "1", text: "Dhanmondi, Dhaka" }, { value: "2", text: "Acapulco, Mexico" }, { value: "3", text: "Berlin, Germany" }, { value: "4", text: "Cannes, France" }, { value: "5", text: "Rawalpindi, Pakistan" }, { value: "6", text: "Giza, Egypt" }, { value: "7", text: "Havana, Cuba" },],
      className: "location",
   },
   {
      id: 3,
   ...
   },
   {
      ...
      col: "col-xl-3",
      label: "Location",
      options: [{ value: "1", text: "Acapulco, Mexico" }, { value: "2", text: "Dhanmondi, Dhaka" }, { value: "3", text: "Berlin, Germany" }, { value: "4", text: "Cannes, France" }, { value: "5", text: "Rawalpindi, Pakistan" }, { value: "6", text: "Giza, Egypt" }, { value: "7", text: "Havana, Cuba" },],
      className: "location",
   },
   {
      id: 3,
   ...
   },
   {
      ...
      col: "mb-25",
      label: "Location",
      options: [{ value: "1", text: "Berlin, Germany" }, { value: "2", text: "Acapulco, Mexico" }, { value: "3", text: "Dhanmondi, Dhaka" }, { value: "4", text: "Cannes, France" }, { value: "5", text: "Rawalpindi, Pakistan" }, { value: "6", text: "Giza, Egypt" }, { value: "7", text: "Havana, Cuba" },],
      className: "location",
   },
   {
      id: 3,
